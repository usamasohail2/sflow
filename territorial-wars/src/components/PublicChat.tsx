...
export function PublicChat({
  ...
  return (
    ...
    >
      {open && (
        <div className="public-chat-panel flex w-[min(20rem,calc(100vw-1.5rem))] flex-col overflow-hidden">
          ...
          >
            ...
            {error && (
              <p className="px-1 text-[10px] text-[var(--signal-bright)]">
                {error}
              </p>
            )}
          </form>
      ...
      <button
        ...
        className="hud-chip inline-flex items-center gap-2 px-3 py-2 text-xs font-semibold"
      >
        <ChatIcon />
